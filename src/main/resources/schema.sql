...
-- tables
-- Table: category (no dependencies)
...
-- Table: ingredient (no dependencies)
...
-- Table: recipe (depends on category)
CREATE TABLE recipe (
    id int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
-- Table: recipe_ingredient (depends on recipe and ingredient)
